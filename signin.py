...
def forget_pass():
    def change_password():
        if user_enter.get()==''or newpass_enter.get()=='' or confiermpass_enter.get()=='':
            ...
            if row == None:
                ...
                mycursor.execute(query,(newpass_enter.get(),user_enter.get()))
                con.commit()
                con.close()
    ...
    user_enter=Entry(window,width=25,fg='magenta2',font=('arial 11 bold'),bd=0)
    user_enter.place(x=470,y=160)
    ...
    newpass_enter=Entry(window,width=25,fg='magenta2',font=('arial 11 bold'),bd=0)
    newpass_enter.place(x=470,y=240)
    ...
    confiermpass_enter=Entry(window,width=25,fg='magenta2',font=('arial 11 bold'),bd=0)
    confiermpass_enter.place(x=470,y=320)
    Frame(window,width=250,height=2,bg='orchid1').place(x=470,y=340)

    submitButton=Button(window,text='Submit',bd=0,bg='magenta2',fg='white',font=('open sans',16,'bold'),width=19,
                        cursor='hand2',activebackground='magenta2',activeforeground='white',command=change_password)
...
usernameEntry=Entry(login_window,font=('Microsoft Yahei UI Light',11,'bold'),bd=0,fg='firebrick1')
...
passwordEntry=Entry(login_window,font=('Microsoft Yahei UI Light',11,'bold'),bd=0,fg='firebrick1')
...
forgetButton=Button(login_window,text='Forget Password?',font=('Microsoft Yahei UI Light',9,'bold'),bd=0,bg='white',activebackground='white'
                 ,cursor='hand2',fg='firebrick1',activeforeground='firebrick1',command=forget_pass)
forgetButton.place(x=715,y=295)

loginButton=Button(login_window,text='Login',font=('open sans',16,'bold')
                    ,activeforeground='firebrick1',bd=0,width=19,activebackground='firebrick1',cursor='hand2'
                    ,fg='white',background='firebrick1',command=login_user)
...
signupLabel=Label(login_window,bg='white',text="Don't have an account?"
...
,activeforeground='blue',bd=0,activebackground='white',cursor='hand2',fg='blue',background='white',command=signup_page)
